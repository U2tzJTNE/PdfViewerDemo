package com.u2tzjtne.mupdf.sample;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lonelypluto.pdfviewerdemo.R.layout.activity_main);
    ...
    private void initData() {
        list = new ArrayList<>();
        List<String> listTitle = Arrays.asList(getResources().getStringArray(com.lonelypluto.pdfviewerdemo.R.array.main_title));
        List<String> listDescribe = Arrays.asList(getResources().getStringArray(com.lonelypluto.pdfviewerdemo.R.array.main_describe));
        for (int i = 0; i < listTitle.size(); i++) {
            MainBean bean = new MainBean();
            bean.setTitle(listTitle.get(i));
            bean.setDescribe(listDescribe.get(i));
            list.add(bean);
        }
    }
    ...
    private void initView() {
        ...
        recyclerView = (RecyclerView) findViewById(com.lonelypluto.pdfviewerdemo.R.id.main_rv);
